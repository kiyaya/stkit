...
/* The following event macros are embedded in the kernel API calls. */
	...
	#define configGENERATE_RUN_TIME_STATS 0
		...
		#define portGET_RUN_TIME_COUNTER_VALUE() vGetTimerCounterForRunTimeStats()
	#endif
    ...
    #define portRESET_RUN_TIME_COUNTER() vResetTimerCounterForRunTimeStats()
