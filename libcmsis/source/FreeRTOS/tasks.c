...
/*
 * Get raw tick count.
 * Some times, we don't quite care about the accuracy, but have big concern
 * on interrupt off period.
 *
 */
portTickType xTaskGetTickCountRaw( void )
{
    return xTickCount;
}
