...
const USBH_ClassTypeDef USBH_msc =
{
  "MSC",
  USB_MSC_CLASS,
        ...
        if( scsi_status == USBH_OK)
        {
             ...
             (MSC_Handle->unit[MSC_Handle->current_lun].sense.key == SCSI_SENSE_KEY_NOT_READY) )   
          {
            if((phost->Timer - MSC_Handle->timer) > 10000 ||
                    MSC_Handle->unit[MSC_Handle->current_lun].sense.asc != SCSI_SENSE_KEY_BLANK_CHECK)
            {
                MSC_Handle->unit[MSC_Handle->current_lun].state = MSC_TEST_UNIT_READY;
                break;
            }
          ...
          //if (MSC_Handle->unit[MSC_Handle->current_lun].sense.asc != SCSI_SENSE_KEY_BLANK_CHECK)
          //{
          //    MSC_Handle->unit[MSC_Handle->current_lun].state = MSC_TEST_UNIT_READY;
          //    break;
          //}
